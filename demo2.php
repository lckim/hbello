...
<html lang="en">
    ...
    <body>
        <div class="container">
            <div class="header">
                <a href="http://tympanus.net/Tutorials/InteractiveTypographyEffects/">
                    <strong>&laquo; Previous Demo: </strong>Interactive Typography Effects
                </a>
                <span class="right">
                    <a href="http://www.flickr.com/photos/gpeters/" target="_blank">Images by Geoff Peters</a>
                    <a href="http://tympanus.net/codrops/2011/11/18/fullscreen-image-blur-effect-with-html5/">
            ...
            <p class="demos"><a href="demo1.php">Demo 1</a> | <a href="demo2.php">Demo 2</a><a class="current-demo" href="demo3.php">Demo 3</a></p>
